...
function mountDataCompanieToSave(companie: ICompanieAeron) {
    return {
        ...
        stateRegistration: companie.inscricaoEstadual ? companie.inscricaoEstadual.toString() : '',
        cityRegistration: companie.inscricaoMunicipal ? companie.inscricaoMunicipal.toString() : '',
